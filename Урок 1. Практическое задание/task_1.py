...
print('Сумма цыфр числа: {}'.format((my_number // 100) + (my_number // 10) % 10 + (my_number % 10)))
print('Произведение цыфр числа: {}'.format((my_number // 100) * ((my_number // 10) % 10) * (my_number % 10)))